...
public class DecodePlate {
    ...
    private static HashMap<String,String> GetBrokenWords ()
    {
        ...
        bw.put ("MFI:DUS",            "I-DUS");             // MFI 'IAP-SDF RWY 34'
    ...
    private static HashSet<String> GetIgnorePlateFixes ()
    {
        ...
        ipf.add ("OCH:IAP-ILS OR LOC RWY 36:ZITGI");    // ZITGI off center
        ...
        ipf.add ("OXC:IAP-RNAV (GPS) RWY 18:WEXNO");
        ...
        */
        ...
        private void matchPlateFixesToMarkers ()
        {
            ...
            while (true) {
                ...
                if (hasANearbyGoodPixel (bestplatefix.posx, bestplatefix.posy)) {
                    ...
                    if (!bestplatefix.dbfix.type.equals ("dmefix")) {
                        ...
                        System.out.println ("matchPlateFixesToMarkers*: dmefix=<" + dmefix.name + ">");
                        if ((dmefix.navaid != null) && (dmefix.distnm > 0) &&
                            !ignorePlateFixes.contains (faaid + ":" + plateid + ":" + dmefix.name)) {
            ...
            do {
                ...
                for (LinkedList<SegNode> loopi : openLoops) {
                    ...
                    for (LinkedList<SegNode> loopj : openLoops) {
                        ...
                        for (int nPtrSegs = 0; ++ nPtrSegs <= 4;) {
                            if (checkForSplitOpenCartoonBubble (loopi, 0, isize - 1, loopj, 0, jsize - nPtrSegs - 1, jsize - nPtrSegs) ||
                                checkForSplitOpenCartoonBubble (loopi, 0, isize - 1, loopj, nPtrSegs, jsize - 1, nPtrSegs - 1)) {
        ...
        {
            if (enda - bega < 2) return false;
            if (endb - begb < 2) return false;
        ...
        private boolean foundACartoonBubble (LinkedList<SegNode> loop, int left, int rite, int top, int bot, SegNode pointsTo)
        {
            ...
            if ((width > csvDpi / 2) && (width < csvDpi * 5 / 4) && (height > csvDpi / 5) && (height < csvDpi / 2)) {
                ////System.out.println ("foundACartoonBubble*: good size, pointsTo=" + ((pointsTo == null) ? "null" : ((pointsTo.index & 0xFFFF) + "," + (pointsTo.index >> 16))));
        ...
        private class PathOpRect extends PathOp {
            public int x, y, u, v;
            ...
            public void draw (PagePanel.Path path)
            {
                ...
                path.gotLineSeg (x, y, u, y);
                path.gotLineSeg (u, y, u, v);
                path.gotLineSeg (u, v, x, v);
                path.gotLineSeg (x, v, x, y);

                g2d.drawLine (x, y, u, y);
                g2d.drawLine (u, y, u, v);
                g2d.drawLine (u, v, x, v);
                g2d.drawLine (x, v, x, y);
