...
// mono --debug MakeWaypoints.exe 20150820 [1 for abbr database used by HSIWatch]
...
public class MakeWaypoints {
    ...
    public static void Main (string[] args)
    {
        ...
        abbrdb = (args.Length > 1) && ((args[1][0] & 1) != 0);

        string dbname = "datums/" + (abbrdb ? "wayptabbs_" : "waypoints_") + expdate + ".db";
        File.Delete (dbname);
        ...
        try {
             ...
             */
            if (abbrdb) {
                DoCommand (dbcon, "CREATE TABLE localizers (loc_type TEXT NOT NULL, loc_faaid TEXT NOT NULL, loc_elev REAL, " +
